      ...
      <div className="w-full max-w-md bg-transparent">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full py-3 px-4 bg-gray-800/50 hover:bg-gray-800/70 border border-gray-900 border-t-gray-500/50 rounded-lg text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2 cursor-pointer"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              autoComplete="off"
              className="w-full px-4 py-3 bg-transparent border border-gray-700/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#BC4918] focus:border-transparent transition-all"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                autoComplete="off"
                className="w-full px-4 py-3 pr-12 bg-transparent border border-gray-700/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#BC4918] focus:border-transparent transition-all"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 accent-[#BC4918] bg-transparent border border-gray-700 rounded focus:outline-none focus:ring-0 focus:ring-offset-0 outline-none ring-0 ring-offset-0 cursor-pointer checked:bg-[#BC4918] checked:border-[#BC4918]"
