  ...
  return (
    <div className="mb-6 flex gap-4">
      ...
      <button
        ...
        className="relative px-18 py-2.5 bg-transparent border-2 border-[var(--color-primary)] rounded text-[var(--color-primary)] text-sm font-medium overflow-hidden transition-all duration-300 cursor-pointer group ml-auto z-0 hover:border-[var(--color-primary-light)]"
      >
