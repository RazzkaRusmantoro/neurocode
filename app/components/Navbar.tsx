      ...
      <div className="flex items-center justify-between px-6 py-6 gap-8 max-w-7xl mx-auto">
        <div className="flex items-center gap-12">
          ...
          <div className="pr-4 flex-shrink-0">
            <img src="/Full-logo.png" alt="Logo" className="h-12 w-auto" style={{ minWidth: 'fit-content' }}/>
          </div>
          
          
          <div className="flex items-center gap-8">
            <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-200 flex items-center gap-1" onClick={(e) => {
            e.preventDefault();
            setSolutionsActive(!solutionsActive);
        }}>
              Solutions
              <svg className={`w-4 h-4 transition-transform duration-200 ${solutionsActive ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            setResourcesActive(!resourcesActive);
              ...
              Resources
              <svg className={`w-4 h-4 transition-transform duration-200 ${resourcesActive ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7"/>
              </svg>
            </a>
          ...
          <a href="/login" className="ml-25 login-play-button" onClick={handleLoginClick}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="36px" height="36px">
              <rect width="36" height="36" x="0" y="0" fill="var(--color-primary)"></rect>
