...
export default function ChatMessageMarkdown({ children }: { children: string }) {
  return (
    <ReactMarkdown
      components={{
        ...
        code: ({ className, children }) => {
          ...
          if (isBlock) return <code className="text-xs text-white/90 font-mono block">{children}</code>;
