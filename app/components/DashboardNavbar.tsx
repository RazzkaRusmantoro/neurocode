      ...
      <div className="flex items-center py-8">
        <div className="flex items-center gap-6 w-full max-w-screen-2xl mx-auto">
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <button className="p-2 text-white/70 hover:text-white transition-colors duration-200 cursor-pointer" aria-label="Add person">
            ...
            <button className="p-2 text-white/70 hover:text-white transition-colors duration-200 cursor-pointer" aria-label="Notifications">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button className="p-2 text-white/70 hover:text-white transition-colors duration-200 cursor-pointer" aria-label="Apps">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
