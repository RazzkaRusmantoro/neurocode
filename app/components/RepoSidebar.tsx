        ...
        <nav className={`flex-1 flex flex-col overflow-y-auto sidebar-scrollbar ${isMinimized ? 'px-2' : 'px-4'} pt-4`}>
          ...
          <div className="pb-3">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <button
                  onClick={handleVisualTreeClick}
                  className={`${BUTTON_BASE_CLASSES} ${activeItem === 'Visual Tree' ? BUTTON_ACTIVE_CLASSES : BUTTON_INACTIVE_CLASSES}`}
                >
              ...
              <li>
                <button
                  onClick={handleCodeReferenceClick}
                  className={`${BUTTON_BASE_CLASSES} ${activeItem === 'Code Reference' ? BUTTON_ACTIVE_CLASSES : BUTTON_INACTIVE_CLASSES}`}
                >
              ...
              <li>
                <button
                  ...
                  className={`${BUTTON_BASE_CLASSES} ${activeItem === 'Glossary' ? BUTTON_ACTIVE_CLASSES : BUTTON_INACTIVE_CLASSES}`}
                >
                  <Icon iconPath="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  <span className={`transition-all duration-300 ${isMinimized ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100 w-auto'}`}>Glossary</span>
                </button>
              </li>
              <li>
                <button
