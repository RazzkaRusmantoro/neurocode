...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      {/* Centered Container */}
      <div className="w-full max-w-7xl flex flex-col lg:flex-row rounded overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-8 lg:py-8">
          ...
          <div className="space-y-3 mb-5">
            <button
              ...
              className="w-full py-2.5 px-4 bg-gray-800/50 hover:bg-gray-800/70 border border-gray-900 border-t-gray-500/50 rounded text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full py-2.5 px-4 bg-gray-900/50 hover:bg-gray-900/70 border border-gray-900 border-t-gray-500/50 rounded text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
