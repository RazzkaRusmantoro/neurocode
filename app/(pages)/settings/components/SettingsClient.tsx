        ...
        <div className="w-full flex flex-col h-full">
          ...
          <div className="mb-8 flex-shrink-0">
            <div className="flex gap-1 border-b border-[#424242]">
              {TABS.map((tab) => (<button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`px-6 py-3 text-sm font-medium transition-colors duration-200 border-b-2 cursor-pointer ${activeTab === tab.id
        ...
        <div className="mb-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col gap-2">
              <button type="button" className="px-4 py-2 bg-[#BC4918] border border-[#BC4918] rounded-lg text-white text-sm hover:bg-[#BC4918]/80 transition-colors duration-200 cursor-pointer">
                Upload Photo
              </button>
      ...
      <div className="border-t border-[#424242] pt-8">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-4 bg-[#FFD45C]/5 border-none rounded-lg transition-all duration-200">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium ${bitbucketConnected
            ? 'bg-green-500/20 text-green-400'
            : 'bg-[#2a2a2a] text-white/50'}`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${bitbucketConnected ? 'bg-green-400' : 'bg-white/30'}`}></span>
            ...
            <button type="button" onClick={() => setBitbucketConnected(!bitbucketConnected)} className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 cursor-pointer whitespace-nowrap flex items-center gap-2 ${bitbucketConnected
