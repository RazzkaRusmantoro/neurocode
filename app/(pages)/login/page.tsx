      ...
      <div className="w-full max-w-md bg-transparent">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-gray-900/50 hover:bg-gray-900/70 border border-gray-900 border-t-gray-500/50 rounded text-white font-medium transition-colors duration-200 flex items-center justify-center gap-2 cursor-pointer"
          >
