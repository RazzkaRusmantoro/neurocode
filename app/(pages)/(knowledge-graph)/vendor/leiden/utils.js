...
UndirectedLeidenAddenda.prototype.mergeNodesSubset = function (start, stop) {
    ...
    var degree, bestCommunity, qualityValueIncrement, maxQualityValueIncrement, totalTransformedQualityValueIncrement, targetCommunity, targetCommunityDegree, targetCommunityWeight;
    ...
    for (s = start; s < stop; s++, ri++) {
        ...
        if (this.externalEdgeWeightPerCommunity[i] <
        ...
        for (ci = 0; ci < neighboringCommunities.size; ci++) {
            ...
            if (this.externalEdgeWeightPerCommunity[targetCommunity] >=
        ...
        if (totalTransformedQualityValueIncrement < Number.MAX_VALUE &&
