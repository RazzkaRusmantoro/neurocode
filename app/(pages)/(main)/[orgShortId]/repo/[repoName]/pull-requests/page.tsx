...
import PullRequestsViewer from './components/PullRequestsViewer';
export default async function PullRequestsPage({ params }: {
    params: Promise<{
        orgShortId: string;
        repoName: string;
    }> | {
    ...
    return (<>
      {repoFullName ? (<PullRequestsViewer repositoryId={repository._id!.toString()} repoFullName={repoFullName} orgShortId={shortId} repoUrlName={repoName} repoName={repository.name}/>) : (<div className="h-full flex items-center justify-center">
