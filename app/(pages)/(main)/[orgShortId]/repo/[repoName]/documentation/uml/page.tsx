...
import UmlDiagramsViewer from '../components/UmlDiagramsViewer';
export default async function UmlDiagramsPage({ params }: {
    params: Promise<{
        orgShortId: string;
        repoName: string;
    }> | {
    ...
    return repoFullName ? (<UmlDiagramsViewer repositoryId={repository._id!.toString()} repoFullName={repoFullName} orgShortId={shortId} repoUrlName={repoName} repoName={repository.name}/>) : (<div className="h-full flex items-center justify-center">
