...
export default async function DocumentationPage({ params }: {
    ...
    return (<>
      {repoFullName ? (<DocumentationViewer repositoryId={repository._id!.toString()} repoFullName={repoFullName} orgShortId={shortId} repoUrlName={repoName} repoName={repository.name}/>) : (<div className="h-full flex items-center justify-center">
