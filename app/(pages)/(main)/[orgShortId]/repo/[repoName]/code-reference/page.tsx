...
export default async function CodeReferencePage({ params }: {
    params: Promise<{
        orgShortId: string;
        repoName: string;
    }> | {
    ...
    return (<>
      {repoFullName ? (<CodeReferenceViewer repositoryId={repository._id!.toString()} repoFullName={repoFullName} orgShortId={shortId} repoUrlName={repoName} repoName={repository.name}/>) : (<div className="h-full flex items-center justify-center">
