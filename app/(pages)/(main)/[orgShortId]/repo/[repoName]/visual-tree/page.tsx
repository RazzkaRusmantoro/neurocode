...
import VisualTreeViewer from '../documentation/components/VisualTreeViewer';
export default async function VisualTreePage({ params }: {
    params: Promise<{
        orgShortId: string;
        repoName: string;
    }> | {
    ...
    return (<>
      {repoFullName ? (<VisualTreeViewer repositoryId={repository._id!.toString()} repoFullName={repoFullName} orgShortId={shortId} repoUrlName={repoName} repoName={repository.name}/>) : (<div className="h-full flex items-center justify-center">
