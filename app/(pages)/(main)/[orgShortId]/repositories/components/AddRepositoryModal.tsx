...
export default function AddRepositoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className={`relative z-10 bg-[#121215] rounded border border-[#262626] p-8 w-full mx-4 shadow-2xl transition-all duration-300 ease-in-out flex flex-col overflow-hidden ${
        ...
        <div className="relative flex-1 min-h-0 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" style={selectedRepository ? { maxHeight: '600px' } : undefined}>
          {selectedRepository ? (
                ...
                <div>
                  <div className="flex items-center justify-between gap-4 mb-3">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-[#262626] hover:bg-[#404040] border border-[#262626] rounded text-white text-sm transition-all duration-200 cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedRepository.topics.map((topic, index) => (
                        <span
                          key={index}
                          className="px-3 py-1 text-xs bg-[#171717]/50 border border-[#262626] text-white/70 rounded"
                        >
                          {topic}
                        </span>
                      ))}
                          ...
                          <div className="space-y-2">
                            {collaborators.map((collab) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 p-2 rounded hover:bg-[#262626] transition-colors cursor-pointer"
                              >
                                <img
              ...
              {isLoading ? (
                <div className="space-y-2">
                  {[...Array(6)].map((_, index) => (
                    <div
                      key={index}
                      className="w-full px-4 py-4 bg-[#262626]/50 border border-[#262626] rounded animate-pulse"
                    >
                ...
                <div className="space-y-2">
                  {filteredRepositories.map((repo) => (
                    <button
                      ...
                      className="w-full px-4 py-4 bg-[#262626]/50 hover:bg-[#262626]/70 border border-[#262626] rounded text-white text-left transition-all duration-200 group cursor-pointer"
                    >
            ...
            className="w-full px-6 py-4 bg-[#262626]/50 hover:bg-[#262626]/70 border border-[#262626] rounded text-white text-left transition-all duration-200 flex items-center gap-3 group cursor-pointer"
          >
        ...
        {selectedRepository && (
          <div className="pt-6 border-t border-[#262626] mt-6 flex-shrink-0">
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] disabled:bg-[var(--color-primary)]/50 disabled:cursor-not-allowed text-white font-medium rounded transition-all duration-200 cursor-pointer"
            >
              Add Repository
            </button>
          </div>
