...
export default function AddRepositoryModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className={`relative z-10 bg-[#121215] rounded-xl border border-[#262626] p-8 w-full mx-4 shadow-2xl transition-all duration-300 ease-in-out flex flex-col overflow-hidden ${
        ...
        <div className="relative flex-1 min-h-0 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" style={selectedRepository ? { maxHeight: '600px' } : undefined}>
          {selectedRepository ? (
                ...
                <div>
                  <div className="flex items-center justify-between gap-4 mb-3">
                    ...
                    <a
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-[#262626] hover:bg-[#404040] border border-[#262626] rounded-lg text-white text-sm transition-all duration-200 cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedRepository.topics.map((topic, index) => (
                        <span
                          key={index}
                          className="px-3 py-1 text-xs bg-[#171717]/50 border border-[#262626] text-white/70 rounded-full"
                        >
                          {topic}
                        </span>
                      ))}
                          ...
                          <div className="space-y-2">
                            {collaborators.map((collab) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 p-2 rounded-lg hover:bg-[#262626] transition-colors cursor-pointer"
                              >
                                <img
                                  src={collab.avatarUrl}
                                  alt={collab.login}
                                  className="w-8 h-8 rounded-full border border-[#262626] flex-shrink-0"
                                />
              ...
              {isLoading ? (
                <div className="space-y-2">
                  {[...Array(6)].map((_, index) => (
                    <div
                      key={index}
                      className="w-full px-4 py-4 bg-[#262626]/50 border border-[#262626] rounded-lg animate-pulse"
                    >
                ...
                <div className="space-y-2">
                  {filteredRepositories.map((repo) => (
                    <button
                      ...
                      className="w-full px-4 py-4 bg-[#262626]/50 hover:bg-[#262626]/70 border border-[#262626] rounded-lg text-white text-left transition-all duration-200 group cursor-pointer"
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-medium text-white group-hover:text-[#5C42CE] transition-colors">
                              {repo.name}
                            </h3>
                            {repo.private && (
                        ...
                        <svg className="w-5 h-5 text-white/70 group-hover:text-[#5C42CE] transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            className="w-full px-6 py-4 bg-[#262626]/50 hover:bg-[#262626]/70 border border-[#262626] rounded-lg text-white text-left transition-all duration-200 flex items-center gap-3 group cursor-pointer"
          >
        ...
        {selectedRepository && (
          <div className="pt-6 border-t border-[#262626] mt-6 flex-shrink-0">
            {error && (
            ...
            <button
              ...
              className="w-full px-6 py-3 bg-[#5C42CE] hover:bg-[#4A35B5] disabled:bg-[#5C42CE]/50 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-all duration-200 cursor-pointer"
            >
              Add Repository
            </button>
          </div>
